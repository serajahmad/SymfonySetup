...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/project/CarTrade/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/project/CarTrade/app/cache/prod/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4e76f5a55c38d7c59b17386f92be2988');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4e76f5a55c38d7c59b17386f92be2988');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4e76f5a55c38d7c59b17386f92be2988');
        ...
        $d->setProxyDir('D:/project/CarTrade/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/project/CarTrade/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/project/CarTrade/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/project/CarTrade/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/project/CarTrade/app/cache/prod/sessions');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/project/CarTrade/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\project\\CarTrade\\src\\Blogger\\GeneralBundle/Resources/views', 'BloggerGeneral');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/project/CarTrade/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/project/CarTrade/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/project/CarTrade/app/cache/prod',
            ...
            'kernel.bundles' => array(
                ...
                'BloggerGeneralBundle' => 'Blogger\\GeneralBundle\\BloggerGeneralBundle',
            ),
            ...
            'debug.container.dump' => 'D:/project/CarTrade/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/project/CarTrade/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/project/CarTrade/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/project/CarTrade/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/project/CarTrade/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/project/CarTrade/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/project/CarTrade/app/cache/prod/doctrine/orm/Proxies',
